...
接着，课程购买服务在接收到请求后，先查询当前的 ID 是否已经处理过，如果是已经处理过的请求，就直接返回结果，不重复执行购买相关的逻辑了。<br>
...
![](<https://static001.geekbang.org/resource/image/d8/66/d8fb321a54d16f8329b200d46a7b3766.jpg?wh=2284x1826>)<br>
...
<center><p><strong>UPDATE table SET balance = balance + 5 WHERE UID = 用户ID ；</strong></p></center>
