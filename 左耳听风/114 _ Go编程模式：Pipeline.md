...
- [Advanced Go Concurrency Patterns – Rob Pike – 2013 Google I/O](<https://blog.golang.org/advanced-go-concurrency-patterns>)<br>

[covers more complex uses of Go’s primitives, especially select.](<https://blog.golang.org/advanced-go-concurrency-patterns>)
- [Squinting at Power Series – Douglas McIlroy's paper](<https://swtch.com/~rsc/thread/squint.pdf>)<br>
